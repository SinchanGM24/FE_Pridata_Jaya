...
const newOutletCriterion = {
	...
	gradeTone: "bg-violet-50 text-violet-700 ring-violet-200",
...
export default function StoreGradeCriteria() {
	return <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
		<div className="border-b border-slate-200 bg-slate-50 px-5 py-5 md:px-6"><div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between"><div className="flex items-start gap-3"><div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-indigo-600 text-white shadow-sm"><BarChart3 aria-hidden="true" className="size-5" /></div><div><p className="text-xs font-semibold uppercase tracking-[0.18em] text-indigo-600">Panduan Grade Outlet</p><h2 className="mt-1 text-xl font-semibold text-slate-900">Kriteria Penilaian Grade</h2><p className="mt-1 max-w-2xl text-sm leading-6 text-slate-600">Grade ditentukan dari rata-rata pembelian bulanan dan rata-rata hari pembayaran outlet.</p></div></div><div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap"><div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-sm"><CalendarDays aria-hidden="true" className="size-4 text-indigo-600" /><div><p className="text-[10px] font-semibold uppercase tracking-wider text-slate-500">Periode</p><p className="text-sm font-semibold text-slate-900">90 hari</p></div></div><div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-sm"><Info aria-hidden="true" className="size-4 text-violet-600" /><div><p className="text-[10px] font-semibold uppercase tracking-wider text-slate-500">Parameter</p><p className="text-sm font-semibold text-slate-900">Pembelian & Pembayaran</p></div></div></div></div></div>
