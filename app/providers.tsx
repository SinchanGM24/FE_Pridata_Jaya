...
function proactiveRefresh(): void {
	// Fire-and-forget. GET /auth/get-session extends the session cookie
	// when called within Better Auth's updateAge window.
	fetch(`${API_BASE_URL}/auth/get-session`, {
		method: "GET",
		credentials: "include",
	}).catch(() => {
		/* best-effort — 401 interceptor handles failure elsewhere */
	});
}
